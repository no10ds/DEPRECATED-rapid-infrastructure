...
sudo -u ubuntu curl -o actions-runner-osx-x64-2.307.1.tar.gz -L https://github.com/actions/runner/releases/download/v2.307.1/actions-runner-osx-x64-2.307.1.tar.gz
sudo -u ubuntu tar xzf ./actions-runner-osx-x64-2.307.1.tar.gz
